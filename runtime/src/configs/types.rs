...
use crate::{
	configs::consts::{
		BLOCK_PROCESSING_VELOCITY, MILLI_UNIT, RELAY_CHAIN_SLOT_DURATION_MILLIS, UNINCLUDED_SEGMENT_CAPACITY,
	},
	AllPalletsWithSystem, ExtrinsicBaseWeight, Runtime, RuntimeCall,
};
...
/// The ID of fungible assets of pallet-assets.
